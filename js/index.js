...
if (document.querySelector('.side-tab a')) {
    ...
    console.log(aboutC.style.display);
    console.log(policyC.style.display);
...
if (document.querySelector('button')) {
    ...
    for (let i = 0; i < frontBtn.length; i++) {
        frontBtn[i].addEventListener('click', (event) => {
            ...
            let newListItem = findData(addBtn[i]);
    ...
    function findData(clickedBtn) {
        ...
        return new Task(clickedIdea.ideaName, clickedIdea.budget, clickedIdea.location, null, false);
    }
